...
<div class="site-info">
	...
	<!-- <span class="footer-info-right">
		<?php echo esc_html_e(' | Powered by', 'smartsg') ?> <a href="<?php echo esc_url('https://superbthemes.com/minimalistblogger/'); ?>" rel="nofollow"><?php echo esc_html_e('Minimalist Blog', 'minimalistblogger') ?></a> <?php echo esc_html_e('WordPress Theme', 'minimalistblogger') ?>
	</span> -->
